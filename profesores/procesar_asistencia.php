...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['fecha'], $_POST['idAsignatura'], $_POST['idCurso'], $_POST['asistencia'])) {
    $fecha = $_POST['fecha'];
    ...
    foreach ($asistencia as $rutAlumno => $presente) {
        ...
        $query_actualizar_asistencia = "UPDATE asistencia SET presente = $presente WHERE fecha = '$fecha' AND idAsignatura = $idAsignatura AND idCurso = $idCurso AND rutAlumno = '$rutAlumno'";
