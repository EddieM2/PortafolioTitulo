...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if (isset($_POST['asignatura_id']) && isset($_POST['idCurso']) && isset($_POST['calificaciones'])) {
        ...
        // Verifica si el promedio se ha calculado
        ...
        foreach ($calificaciones as $rut_alumno => $notas) {
            ...
            if (mysqli_num_rows($result_verificar_calificaciones) > 0) {
                ...
                $query_actualizar_calificaciones = "UPDATE calificaciones SET calificacion1 = '$nota1', calificacion2 = '$nota2', calificacion3 = '$nota3', calificacion4 = '$nota4', fecha = NOW()";
                if ($promedio !== null) {
                    $query_actualizar_calificaciones .= ", promedio = '$promedio'";
                }
                $query_actualizar_calificaciones .= " WHERE idAlumno = '$rut_alumno' AND idAsignatura = '$asignatura_id' AND idCurso = '$idCurso'";
